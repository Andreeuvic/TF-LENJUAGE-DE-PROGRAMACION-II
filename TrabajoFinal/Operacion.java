        ...
        Scanner sc = new Scanner(System.in);
            ...
            while (tipo != 4){
                ...
                case 1: // Realiza la operacion deposito
                    ...
                    System.out.println("Cantidad depositada: " + montoDepositar);
                ...
                case 2: // Realiza la operacion de retiro
                    ...
                    if (montoRetirar > saldoInicial){
                        System.out.println("Lo siento, su saldo es insuficiente");
                    }else{
                        saldoInicial = saldoInicial - montoRetirar;
                        System.out.println("Cantidad retirada: " + montoRetirar);
